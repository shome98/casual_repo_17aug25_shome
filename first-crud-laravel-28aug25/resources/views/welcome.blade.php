<x-layout title="Welcome😊">
    ...
    @auth
        ...
        <form action="/logout" method="POST">
            @csrf
            <button class="button-red">Log out</button>
        </form>
        <br />
        ...
        <br />
        <div class="small-box-col">
            <h1 class="text-3xl text-center">All User Posts</h1>
        ...
        <form method="POST" action='/register'>
            ...
            <div class="box-2">
                <div class="flex-col-2">
                    ...
                    <input id="name" name="name" type="text" class="input-normal"
